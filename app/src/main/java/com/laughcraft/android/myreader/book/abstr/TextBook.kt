...
abstract class TextBook : File, Book {
    abstract val title: String
    abstract val chaptersCount: Int
    abstract val encoding: String
    abstract val tableOfContents: List<String>?
    ...
    abstract suspend fun getChapter(index: Int): String
    
    open fun getCharsetName(file: File): String = ""
    
    protected open fun onBookError(throwable: Throwable) {
